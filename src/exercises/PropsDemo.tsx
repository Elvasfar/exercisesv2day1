...
export default function PropsDemo({ title }: BaseProps) {
  ...
  return (
    <>
      ...
      <Profile name="Marge Simpson" email="ms@gmail.com" isActive={false} singleLine={showHorizontal} />
      <Profile name="Homer Simpson" email="hs@hotmail.com" isActive={true} singleLine={showHorizontal} />
